...
export default function AddShiftMapping() {
  ...
  // EDIT
  const openEdit = async (item: ShiftMapping) => {
    ...
    const { value } = await Swal.fire({
      ...
      preConfirm: () => {
        ...
        const toleransi_telat = Number((document.getElementById("toleransi") as HTMLInputElement).value);
  ...
  return (
    <>
      <PageMeta title="Tambah Shift Pegawai" description="Shift Mapping" />
      <PageHeader
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
        {/* FORM INPUT*/}
        <ComponentCard title="Form Input Shift Pegawai">
              ...
              <tbody>
                {mapping.map((m, i) => (
                  ...
                  >
                    ...
                    <td className="p-3">{m.toleransi_telat === 0
                        ? "Tidak ada"
                        : `${m.toleransi_telat} menit`}
                    </td>
